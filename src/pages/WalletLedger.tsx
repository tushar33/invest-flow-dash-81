  ...
  const { data: walletData, isLoading } = useQuery({
    ...
    queryFn: () => {
      if (isAdmin && selectedUserId) {
        return admin.userWallet(selectedUserId);
      }
      return wallet.get();
    },
  });
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground text-sm">Complete transaction history and wallet summary.</p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex gap-2">
                ...
                <Button onClick={() => setSelectedUserId(userSearch)} disabled={!userSearch.trim()}>
                  Load Wallet
                </Button>
              </div>
            </CardContent>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold">₹{walletData.availableBalance.toLocaleString()}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-success">₹{totalCredits.toLocaleString()}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  <div key={txn.id} className="flex items-center gap-4 p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge variant={txn.direction === "CREDIT" ? "default" : "destructive"} className="text-xs">
                          {txn.direction}
                        </Badge>
                      </div>
                      ...
                      {txn.referenceId && (
                        <p className="text-xs text-muted-foreground mt-1">Ref: {txn.referenceId}</p>
                      )}
                    </div>

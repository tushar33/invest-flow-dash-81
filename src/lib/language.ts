...
export const LANG = {
  ...
  auth: {
    ...
    identifierPlaceholder: "Enter User ID (Example: TA2034)",
    password: "Password",
    ...
    enterIdentifier: "Enter your User ID",
    forgotPassword: "Forgot password?",
    forgotPasswordTitle: "Reset your password",
    forgotPasswordDescription:
      "Enter your User ID and registered email address. We'll send a reset link if the details match our records.",
    registeredEmailPlaceholder: "Enter registered email address",
    sendResetLink: "Send reset link",
    sendingResetLink: "Sending...",
    resetLinkSent: "Check your email",
    resetLinkSentDescription:
      "If the provided details match our records, a password reset link has been sent.",
    ...
    invalidResetLinkDescription: "This link is missing or expired. Request a new one.",
  ...
  reward: {
    ...
    runLogViewPackages: "View packages",
    runLogHidePackages: "Hide packages",
    runLogCreditedPackages: "Credited packages",
    runLogCycleLabel: (n: number) => `Cycle ${n}`,
    runLogNoPackageDetails: "Package details unavailable for this run",
  ...
  plans: {
    ...
    editDateTooltip: "Edit plan before first reward",
    onlyActiveCancelTooltip: "Only active plans can be cancelled",
    cancelPlanTooltip: "Cancel this plan",
    editAssignmentDate: "Edit Plan",
    editPlanHint: "Only allowed when no reward cycles have been processed.",
